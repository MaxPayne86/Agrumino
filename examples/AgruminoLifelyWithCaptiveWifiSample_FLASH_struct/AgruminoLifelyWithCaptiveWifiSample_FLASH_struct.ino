...
#define SLEEP_TIME_SEC 5 // 1 hour
...
void loop() {
  ...
  if (currentIndex == N_SAMPLES - 1) {
    ...
    for (uint8_t i = 0; i < N_SAMPLES; i++) {
      ...
      sendData(deviceKey, deviceToken, PtrFlashMemory->Fields.data.vector[i].temp, PtrFlashMemory->Fields.data.vector[currentIndex].soil, PtrFlashMemory->Fields.data.vector[currentIndex].lux, PtrFlashMemory->Fields.data.vector[currentIndex].batt, PtrFlashMemory->Fields.data.vector[currentIndex].battLevel, PtrFlashMemory->Fields.data.vector[currentIndex].usb, PtrFlashMemory->Fields.data.vector[currentIndex].charge);
